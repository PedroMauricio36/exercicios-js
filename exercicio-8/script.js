function calcularMedia() {
    ...
    if (calculo==10) { 
        document.getElementById("resultadoPlus").innerHTML = "Aprovado com Distinção.";
    } else if (calculo>=7) {
        document.getElementById("resultadoPlus").innerHTML = "Aprovado.";
    }
    else {
        document.getElementById("resultadoPlus").innerHTML = " Reprovado.";
    }
}